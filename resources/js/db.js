...
/**
 * Menghitung persentase diskon dari harga asli dan harga saat ini
 * @param {number} price - Harga saat ini
 * @param {number|null} originalPrice - Harga asli (sebelum diskon)
 * @returns {number|null} Persentase diskon (dibulatkan), atau null jika tidak ada diskon
 */
window.calculateDiscount = function(price, originalPrice) {
...
window.games = [
  {
    ...
    stores: [
      { store: "G2A",        price: 345000, originalPrice: 375000, discountPercent: calculateDiscount(345000, 375000), url: "https://www.g2a.com" },
      { store: "Epic Games", price: 355810, originalPrice: null,   discountPercent: calculateDiscount(355810, null), url: "https://www.epicgames.com" },
      { store: "Steam",      price: 395410, originalPrice: null,   discountPercent: calculateDiscount(395410, null), url: "https://store.steampowered.com" },
      { store: "GOG",        price: 267670, originalPrice: null,   discountPercent: calculateDiscount(267670, null), url: "https://www.gog.com" },
      { store: "Origin",     price: 380000, originalPrice: 450000, discountPercent: calculateDiscount(380000, 450000), url: "https://www.origin.com" },
      { store: "Uplay",      price: 370000, originalPrice: null,   discountPercent: calculateDiscount(370000, null), url: "https://www.ubisoft.com" },
      { store: "Xbox Store", price: 340000, originalPrice: 400000, discountPercent: calculateDiscount(340000, 400000), url: "https://www.xbox.com" },
      { store: "PlayStation", price: 360000, originalPrice: null,   discountPercent: calculateDiscount(360000, null), url: "https://www.playstation.com" },
      { store: "Humble",     price: 330000, originalPrice: 400000, discountPercent: calculateDiscount(330000, 400000), url: "https://www.humblebundle.com" },
      { store: "Fanatical",  price: 350000, originalPrice: null,   discountPercent: calculateDiscount(350000, null), url: "https://www.fanatical.com" }
    ]
  },
  {
    id: "witcher-2",
