					...
					<div class="flex flex-col gap-3 sm:gap-4">
						...
						<div class="flex items-center justify-between flex-wrap gap-3 text-xs sm:text-sm pt-1">
							...
							@if (Route::has('password.request'))
								<a href="{{ route('password.request') }}" class="font-mono font-medium uppercase tracking-wider text-secondary hover:text-white hover:underline transition-colors">Forgot?</a>
							@endif
						</div>
					</div>
